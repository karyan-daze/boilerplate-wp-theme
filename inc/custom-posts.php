...
// Register Custom Taxonomy
    function category_taxonomy() {
        ...
        $labels = array(
            'name'                       => _x( 'Categories', 'Taxonomy General Name', 'airteam' ),
            'singular_name'              => _x( 'Category', 'Taxonomy Singular Name', 'airteam' ),
            'menu_name'                  => __( 'Category', 'airteam' ),
            'all_items'                  => __( 'All Items', 'airteam' ),
            'parent_item'                => __( 'Parent Item', 'airteam' ),
            'parent_item_colon'          => __( 'Parent Item:', 'airteam' ),
            'new_item_name'              => __( 'New Item Name', 'airteam' ),
            'add_new_item'               => __( 'Add New Item', 'airteam' ),
            'edit_item'                  => __( 'Edit Item', 'airteam' ),
            'update_item'                => __( 'Update Item', 'airteam' ),
            'view_item'                  => __( 'View Item', 'airteam' ),
            'separate_items_with_commas' => __( 'Separate items with commas', 'airteam' ),
            'add_or_remove_items'        => __( 'Add or remove items', 'airteam' ),
            'choose_from_most_used'      => __( 'Choose from the most used', 'airteam' ),
            'popular_items'              => __( 'Popular Items', 'airteam' ),
        ...
        register_taxonomy( 'project_category', array( 'medias' ), $args );
